      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Get started with DocProcessor today
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-md">
          <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    required
                    className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all font-semibold text-sm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl shadow-md shadow-indigo-100 hover:shadow-lg transition-all disabled:opacity-50 flex justify-center items-center space-x-1.5 cursor-pointer mt-6"
            >
              {loading ? (
                <>
